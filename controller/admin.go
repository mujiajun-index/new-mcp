...
func GetLogs(c *gin.Context) {
	...
	items, total, err := adminService.GetLogsForUser(userID, isAdmin, &filter, page, pageSize)
	if err != nil {
...
func GetLogStats(c *gin.Context) {
	...
	stats, err := adminService.GetLogStatsForUser(userID, isAdmin, &filter)
	if err != nil {
