...
var MetaTools = []struct {
...
}{
	{
		...
		InputSchema: json.RawMessage(`{
			"type": "object",
			"properties": {
				"query": {"type": "string", "description": "Keywords matched against names and descriptions (Chinese is auto-matched via pinyin). For non-English tasks include both the task language and its English translation for best ranking; for English tasks plain English, e.g. \"weather forecast\". Omit to browse available items."},
